...
export default function SignInForm() {
  ...
  return (
    <div className="min-h-screen flex flex-col items-center justify-start bg-[#EFE9D5] px-4 py-10 sm:py-10">
      ...
      <div className="w-full max-w-lg bg-white border border-black border-b-2 rounded-2xl shadow-md p-4 sm:p-6">
        <h2 className="text-2xl sm:text-3xl font-bold text-[#0f2430] mb-3 sm:mb-4 text-center">Sign in to your account</h2>
        <p className="text-center text-sm text-gray-500 mb-5 sm:mb-6">Enter your credentials or sign in via Google</p>
        ...
        <form onSubmit={form.handleSubmit(onSubmit)}>
          ...
          <div className="mt-6 sm:mt-8">
            <Button
              ...
              className="w-full rounded-md bg-white hover:bg-gray-200 text-black font-semibold py-3 border border-black border-b-2 disabled:opacity-60"
            >
          ...
          <div className="mt-3 sm:mt-4">
            <Button
              ...
              className="w-full bg-white hover:bg-gray-200 border border-black border-b-2 rounded-lg py-2 flex items-center justify-center gap-2 transition text-black"
            >
          ...
          <div className="mt-5 sm:mt-6 text-center text-sm flex items-center justify-center flex-wrap gap-1">
            <span className="text-gray-400 font-semibold">New to ReviewMe?</span>
            <HoverCard>
              <HoverCardTrigger asChild>
                <Button variant="link" className="bg-white p-0 h-auto">
                  <Link href="/sign-up" className="text-black font-medium">Sign up</Link>
                </Button>
              </HoverCardTrigger>
            </HoverCard>
          </div>
